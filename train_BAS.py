...
if __name__ == "__main__":
    ...
    valid_loader = DataLoader(valid_dataset, batch_size=4, shuffle=Fals  e, num_workers=3)

    # Some training hyperparameters
    EPOCHS = 10
    T_MAX = EPOCHS * len(train_loader)

    model = CamVidModel("DeepLabV3", "resnext50_32x4d", in_channels=3, obj_classes=len(train_dataset.OBJ_CLASSES), area_classes=len(train_dataset.AREA_CLASSES))
